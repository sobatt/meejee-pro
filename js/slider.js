function SliderLock(selector,callback) {
	...
	////初始化组件
	var $div = $(selector);
	$div.append($("<div id='sliderLock_huakuai'><div></div></div><p id='sliderLock_status'>Please slide the slide to the right.</p>"));
...
//是否可拖动状态
	...
	this.complete = function(){
		...
		this.active = false;
		$status.text("Completion of verification");
		//状态栏 对齐
	...
	position.left +=($div.innerWidth()-$status.width())*2;
