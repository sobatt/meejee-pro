...
(function($){
	...
	function _setCodeStyle(eid, codeType, codeLength){
		...
		htmlCode+='" href="#" onblur="return false" onfocus="return false" oncontextmenu="return false" onclick="$.idcode.setCode()">' + _setStyle(codeObj) + '</div>' + '<div id="ehong-code-tip-ck" class="ehong-code-val-tip" onclick="$.idcode.setCode()">'+ settings.codeTip +'</div>';
		$(eid).html(htmlCode);
